(function () {
  const groups = [
  {
    ...
    "pages": [
      ...
      {
        "title": "가온길 수시상담 페이지 (2026 입결 + 2027 모집정보)",
        "url": "susi-consult.html",
        "current": "입시결과 조회",
        "tags": [
          "results",
          "susi",
  ...
  },
  {
    ...
    "pages": [
      {
        "title": "계열 선택형 탐구주제 설정 (3,866개 주제)",
        "url": "tamgu/index.html",
        "current": "탐구주제",
        "tags": [
          "topic",
          "research",
      ...
      {
        "title": "과목별 연구자료 아카이브 (2,962건 · Drive 연결)",
  ...
  },
  {
    ...
    "pages": [
      ...
      },
      {
        ...
        "status": "신규",
        "brandNote": "가온길 에듀 · 가온길 에듀 입시전략연구소",
        "key": "admissionTypeResults"
      },
      {
        "title": "전형유형별 고교유형 선발 비율 (2023~2025)",
        "url": "highschool-type-ratio.html",
        "current": "선발 통계",
        "tags": [
          "statistics",
          "highschool-type",
